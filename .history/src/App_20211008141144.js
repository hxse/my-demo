    ...
    <div className="App">
      <div className="container" style={{ height: use100vh() * 0.95 }}>
        ...
        <div id="reader" className="content">
          ...
          <div className="hr-wrapper">
            <hr id="content2HrUp" className="hr-edge-weak-half" onClick={contentPage.bind(this, "#content2", "up")} />
            <hr id="content2HrDown" className="hr-edge-weak-half" onClick={contentPage.bind(this, "#content2", "down")} />
          </div>
          <div id="translate">
