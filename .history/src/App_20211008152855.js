...
function App() {
  ...
  function contentPage(id, way) {
    ...
    for (let span of contentDiv.querySelectorAll("span")) {
      // console.log(1234, span.clientTop, contentDiv.clientHeight);
      if (span.clientTop < 0) {
        console.log("上方", span.clientTop,  contentDiv.clientHeight, span);
      }
      if (span.clientTop >= 0 && span.clientTop <= contentDiv.clientHeight) {
        console.log("中央", span.clientTop,  contentDiv.clientHeight, span);
      }
      if (span.offsetBottom > contentDiv.clientHeight) {
        console.log("下方", span.clientTop,  contentDiv.clientHeight, span);
      }
    }
    if (way == "down") {
