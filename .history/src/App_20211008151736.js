...
function App() {
  ...
  function contentPage(id, way) {
    ...
    for (let span of contentDiv.querySelectorAll("span")) {
      ...
      if (span.offsetTop < 0) {
        console.log("上方", span.offsetTop, span.scrollHeight, contentDiv.clientHeight, span);
      }
      if (span.offsetTop >= 0 && span.offsetTop <= contentDiv.clientHeight) {
        console.log("中央", span.offsetTop, span.scrollHeight, contentDiv.clientHeight, span);
      }
      if (span.offsetTop > contentDiv.clientHeight) {
        console.log("下方", span.offsetTop, span.scrollHeight, contentDiv.clientHeight, span);
      }
    }
    if (way == "down") {
