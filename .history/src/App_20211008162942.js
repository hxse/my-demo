  ...
  function contentPage(id, way) {
    ...
    for (let span of contentDiv.querySelectorAll("span")) {
      ...
      if (
        ...
        span.offsetTop - span.clientHeight < contentDiv.scrollTop + contentDiv.clientHeight
      ) {
        console.log("下方临界", span.offsetTop, contentDiv.scrollTop, contentDiv.offsetHeight, span);
        _spanDown = span;
      }
      if (span.offsetTop - span.clientHeight > contentDiv.scrollTop + contentDiv.clientHeight) {
