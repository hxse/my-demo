...
function App() {
  ...
  function contentPage(id, way) {
    ...
    for (let span of contentDiv.querySelectorAll("span")) {
      console.log(1234, span.offsetTop, span.offsetBottom, contentDiv.clientHeight);
      if (span.offsetTop < 0) {
        // console.log("上方", span.offsetTop,  contentDiv.clientHeight, span);
      }
      if (span.offsetTop >= 0 && span.offsetTop <= contentDiv.clientHeight) {
        // console.log("中央", span.offsetTop,  contentDiv.clientHeight, span);
      }
      if (span.offsetBottom > contentDiv.clientHeight) {
        // console.log("下方", span.offsetTop,  contentDiv.clientHeight, span);
      }
    }
    if (way == "down") {
